...
`;
    ...
    function apply(ctx) {
      ...
      ctx.slots.inject("tool.call.toolview", function* () {
        ...
        yield ctx.slots.register({ name: "tool.call.toolview", key: "apply_patch" }, EditWriteView);
        yield ctx.slots.register({ name: "tool.call.toolview", key: "apply-patch" }, EditWriteView);
        yield ctx.slots.register({ name: "tool.call.toolview", key: "applypatch" }, EditWriteView);
      });
    }
